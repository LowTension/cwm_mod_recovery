...
RECOVERY_NAME := CWMRecovery
endif
endif

RECOVERY_VERSION := $(RECOVERY_NAME) carliv swipe
...
ifeq ($(DEVICE_SCREEN_WIDTH), 240)
    BOARD_USE_CUSTOM_RECOVERY_FONT := \"font14_8x17.h\"
endif
ifeq ($(DEVICE_SCREEN_WIDTH), 320)
    BOARD_USE_CUSTOM_RECOVERY_FONT := \"font16_10x19.h\"
endif
ifeq ($(DEVICE_SCREEN_WIDTH), 480)
    BOARD_USE_CUSTOM_RECOVERY_FONT := \"font22_13x27.h\"
endif
ifeq ($(DEVICE_SCREEN_WIDTH), 540)
    BOARD_USE_CUSTOM_RECOVERY_FONT := \"font24_14x29.h\"
endif
ifeq ($(DEVICE_SCREEN_WIDTH), 600)
    BOARD_USE_CUSTOM_RECOVERY_FONT := \"font25_15x30.h\"
endif
ifeq ($(DEVICE_SCREEN_WIDTH), 720)
    BOARD_USE_CUSTOM_RECOVERY_FONT := \"font27_16x33.h\"
endif
ifeq ($(DEVICE_SCREEN_WIDTH), 768)
    BOARD_USE_CUSTOM_RECOVERY_FONT := \"font26_16x32.h\"
endif
ifeq ($(DEVICE_SCREEN_WIDTH), 800)
    BOARD_USE_CUSTOM_RECOVERY_FONT := \"font28_17x33.h\"
endif
ifeq ($(DEVICE_SCREEN_WIDTH), 1080)
    BOARD_USE_CUSTOM_RECOVERY_FONT := \"font40_24x48.h\"
endif
ifeq ($(DEVICE_SCREEN_WIDTH),)
    BOARD_USE_CUSTOM_RECOVERY_FONT := \"font20_12x24.h\"
endif
else
...
RECOVERY_BUILD_ID := $(BUILD_ID)
LOCAL_CFLAGS += -DBOARD_RECOVERY_CHAR_WIDTH=$(BOARD_RECOVERY_CHAR_WIDTH) -DBOARD_RECOVERY_CHAR_HEIGHT=$(BOARD_RECOVERY_CHAR_HEIGHT) -DRECOVERY_BUILD_DATE="$(RECOVERY_BUILD_DATE)" -DRECOVERY_BUILD_USER="$(RECOVERY_BUILD_USER)" -DRECOVERY_BUILD_HOST="$(RECOVERY_BUILD_HOST)" -DRECOVERY_BUILD_ID="$(RECOVERY_BUILD_ID)"

BOARD_RECOVERY_DEFINES := BOARD_HAS_NO_SELECT_BUTTON BOARD_UMS_LUNFILE BOARD_RECOVERY_ALWAYS_WIPES BOARD_RECOVERY_HANDLES_MOUNT BOARD_TOUCH_RECOVERY RECOVERY_EXTEND_NANDROID_MENU TARGET_USE_CUSTOM_LUN_FILE_PATH TARGET_DEVICE TARGET_RECOVERY_FSTAB BOARD_NATIVE_DUALBOOT BOARD_NATIVE_DUALBOOT_SINGLEDATA BOARD_HAS_MTK CUSTOM_BATTERY_FILE CUSTOM_BATTERY_STATS_PATH BOARD_NEEDS_MTK_GETSIZE
